...
outputpath=~/synkrotomo/output/lbsc/astravsfut/$now
...
futhark opencl ~/archive/synkrotomo-25dec/futhark/backprojection.fut
futhark bench --runs=10 --skip-compilation ~/synkrotomo/futhark/backprojection.fut | bash ~/tomography/runscripts/formatfuthark.sh $outputpath/fut_bp.csv
futhark opencl ~/synkrotomo/futhark/forwardprojection.fut
futhark bench --runs=10 --skip-compilation ~/synkrotomo/futhark/forwardprojection.fut | bash ~/tomography/runscripts/formatfuthark.sh $outputpath/fut_fp.csv
futhark opencl ~/synkrotomo/futhark/backprojection.fut
futhark bench --runs=10 --skip-compilation ~/synkrotomo/futhark/backprojection.fut | bash ~/tomography/runscripts/formatfuthark.sh $outputpath/fut_bp.csv
futhark opencl ~/synkrotomo/futhark/forwardprojection.fut
futhark bench --runs=10 --skip-compilation ~/synkrotomo/futhark/forwardprojection.fut | bash ~/tomography/runscripts/formatfuthark.sh $outputpath/fut_fp.csv
...
python plot_speedup_same_graf.py -d $outputpath -t "Speedup full angles" -x "N" -y "speedup"
cd ~/synkrotomo
git add $outputpath/*
